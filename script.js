...
let dailyMessage = "You are so beautiful. I love you 😍"; // Default fallback
...
async function loadDailyMessage() {
  try {
    ...
    dailyMessage = todaysMessageObj ? todaysMessageObj.message : "You are so beautiful. I love you 😍";
    return dailyMessage;
  } catch (error) {
